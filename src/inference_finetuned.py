...
if __name__ == "__main__":
    ...
    if args.majority_voting:
        output_path = os.path.join(output_dir, f"{prompting_strategy}_finetuned_majority_voting_raw_predictions.jsonl")
    else:
        output_path = os.path.join(output_dir, f"{prompting_strategy}_finetuned_raw_predictions.jsonl")

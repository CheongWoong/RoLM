...
if __name__ == "__main__":
    ...
    output_score_path = os.path.join(output_dir, f"{prompting_strategy}_score_validation.json")
    raw_predictions_path = os.path.join(output_dir, f"{prompting_strategy}_raw_predictions_validation.jsonl")
